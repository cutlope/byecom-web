  ...
  return (
    <React.Fragment>
      <TableRow className={clsx(classes.tableRowRoot, open ? 'active' : '')}>
        <TableCell className={clsx(classes.tableCellRoot, classes.tableCellFirst)}>{goods._id}</TableCell>
        <TableCell className={clsx(classes.tableCellRoot, classes.tableCellFirst)}>
          <CmtObjectSummary
            avatar={<CmtAvatar src={goods.svgImage} alt={goods.name} color="transparent" size={60} />}
            title={goods.name}
        ...
        <TableCell className={clsx(classes.tableCellRoot, classes.tableCellSecond)}>
          {goods.activeStatus ? '🟢 Active' : '🔴 Inactive'}
        </TableCell>
