  ...
  return (
    <React.Fragment>
      <TableRow className={clsx(classes.tableRowRoot, open ? 'active' : '')}>
        <TableCell className={clsx(classes.tableCellRoot, classes.tableCellSecond)}>{pack.category}</TableCell>

        <TableCell className={clsx(classes.tableCellRoot, classes.tableCellSecond)}>
          {pack.from_pack} - {pack.to_pack}{' '}
        </TableCell>

        <TableCell className={clsx(classes.tableCellRoot, classes.tableCellSecond)}>₹{pack.rate}</TableCell>
        <TableCell className={clsx(classes.tableCellRoot, classes.tableCellSecond)}>
          {pack.activeStatus ? '🟢 Active' : '🔴 Inactive'}
        </TableCell>
